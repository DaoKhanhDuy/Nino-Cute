...
module.exports.onLoad = async() => {
    ...
    const path = resolve(dirMaterial, 'rank1.png');
    const path1 = resolve(dirMaterial, 'rank2.png');
    const path2 = resolve(dirMaterial, 'rank3.png');
...
module.exports.makeRankCard = async (data) => {    
    ...
    */
	...
	const pathImg = __root + `/rank (${id}).png`;
